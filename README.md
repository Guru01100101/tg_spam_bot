...
- 👑 Управління адміністраторами — додавання/видалення, додати адміністраторів чату
  - Адміністратору надходить сповіщення зі скаргою та кнопками для швидкої модераціїня словами — додавання/видалення/перегляд списку
- 👑 Управління адміністраторами — додавання/видалення, додати адміністраторів чату
...
3. Якщо все в порядку, бот пересилає повідомлення адміністраторам зі спеціальними кнопками:
   ...
   - ✅ Ігнорувати — ігнорує скаргу, якщо вона помилковаps for deleting spam messages
